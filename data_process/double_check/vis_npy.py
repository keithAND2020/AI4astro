...
# import pdb
# # 加载 .npy 文件
# patch_data = np.load('/ailab/user/zhuangguohang/ai4stronomy/Astro_SR/dataset/train_lr_patch/hst_9444_01_acs_wfc_f814w_j6lk01_drc_patch_0_lr.npy', allow_pickle=True)#.item()
# pdb.set_trace()
